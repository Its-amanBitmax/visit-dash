...
@section('title', 'TL Evaluation Reports')
@section('header', 'TL Evaluation Reports')
                    ...
                    @forelse ($reports as $report)
                        <tr>
                            ...
                            <td style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
                                <a class="btn" href="{{ route('tl-evaluation-reports.pdf', $report->id) }}">PDF</a>
                                <a class="btn btn-secondary" href="{{ route('tl-evaluation-reports.show', $report->id) }}">View</a>
                                <a class="btn btn-secondary" href="{{ route('tl-evaluation-reports.edit', $report->id) }}">Edit</a>
                                <form method="POST" action="{{ route('tl-evaluation-reports.destroy', $report->id) }}">
                                    @csrf
                                    @method('DELETE')
